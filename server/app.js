...
var annotateRouter = require('./routes/annotate');
var uploadImageRouter = require('./routes/uploadImage');
var uploadAnnotationPathRouter = require('./routes/uploadAnnotationPath');
var eventsPathRouter = require('./routes/events');
var imageRouter = require('./routes/image');
var annotationRouter = require('./routes/annotation');
var annotationTextUploadRouter = require('./routes/annotationTextUpload');
...
app.use('/', uploadAnnotationPathRouter);
app.use('/', eventsPathRouter);
app.use('/', imageRouter);
app.use('/', annotationRouter);
app.use('/', annotationTextUploadRouter);
